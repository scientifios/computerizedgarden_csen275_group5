...
import CSEN275Garden.simulation.SimulationEngine.SimulationState;
...
public class SimulationEngineTest {
    ...
    void setUp() {
        ...
        garden.addPlant(new Flower(new GridPosition(0, 0), "TestFlower"));
    }
    ...
    void testLivingPlantsSync() {
        ...
        garden.addPlant(new Flower(new GridPosition(2, 2), "Rose"));
