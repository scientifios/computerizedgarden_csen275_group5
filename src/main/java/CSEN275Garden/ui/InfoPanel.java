...
public class InfoPanel extends VBox {
    ...
    private Label hiddenTimeLabel;
    private Label hiddenStatsLabel;
    private Label hiddenHeatingLabel;
    private Label hiddenTempLabel;
    private WeatherDisplay hiddenWeatherDisplay;
    private ProgressBar hiddenWaterBar;
    private ProgressBar hiddenPesticideBar;
    ...
    private void buildLeftSystemsPanel() {
        ...
        hiddenTimeLabel = weatherCard.addLabel("", false);
        hiddenTimeLabel.setManaged(false);
        hiddenTimeLabel.setVisible(false);
        hiddenStatsLabel = weatherCard.addLabel("", false);
        hiddenStatsLabel.setManaged(false);
        hiddenStatsLabel.setVisible(false);
        weatherLabel = weatherCard.addLabel("Weather: --", false);
        ambientTemperatureLabel = weatherCard.addLabel("Ambient Temperature: --", false);
        hiddenWeatherDisplay = new WeatherDisplay();
        hiddenWeatherDisplay.setManaged(false);
        hiddenWeatherDisplay.setVisible(false);
        weatherCard.getChildren().add(hiddenWeatherDisplay);
        ...
        hiddenHeatingLabel = heatingStatusLabel;
        hiddenTempLabel = gardenTemperatureLabel;
        ...
        hiddenWaterBar = new ProgressBar(1.0);
        hiddenPesticideBar = new ProgressBar(1.0);
    ...
    public void updateGardenInfo(
        ...
        int storedPlants,
        List<Plant> plants,
        Map<GridPosition, Integer> activePestsByPosition
    ) {
    ...
    private String formatPosition(GridPosition position) {
    ...
    public Label getTimeLabel() { return hiddenTimeLabel; }
    public Label getStatsLabel() { return hiddenStatsLabel; }
    public Label getHeatingStatusLabel() { return hiddenHeatingLabel; }
    public Label getTemperatureLabel() { return hiddenTempLabel; }
    public WeatherDisplay getWeatherDisplay() { return hiddenWeatherDisplay; }
    public ProgressBar getWaterBar() { return hiddenWaterBar; }
    public ProgressBar getPesticideBar() { return hiddenPesticideBar; }
