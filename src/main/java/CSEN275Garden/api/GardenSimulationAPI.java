...
import CSEN275Garden.simulation.HeadlessSimulationEngine;
...
import CSEN275Garden.system.HarmfulPest;
...
private static void loadDefaultPestVulnerabilities() {
    ...
    */
    public void initializeGarden() {
        ...
        try {
            ...
            if (configStream == null) {
                ...
                addPlants(PlantType.STRAWBERRY, new GridPosition(1, 1));
                addPlants(PlantType.CABBAGE, new GridPosition(2, 2));
                addPlants(PlantType.TOMATO, new GridPosition(3, 3));
                addPlants(PlantType.LILY, new GridPosition(4, 4));
            } else {
                String configContent = new String(configStream.readAllBytes());
                configStream.close();
     ...
     */
    private void addPlants(PlantType plantType, GridPosition position) {
    ...
    */
    ...
    private void loadPlantsFromConfig(String configContent) {
        ...
        while (matcher.find()) {
            ...
            if (plantType != null) {
                addPlants(plantType, new GridPosition(row, column));
                plantCount++;
            } else {
